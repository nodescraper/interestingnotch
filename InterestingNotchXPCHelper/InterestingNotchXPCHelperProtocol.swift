//
//  InterestingNotchXPCHelperProtocol.swift
//  InterestingNotchXPCHelper
//
...
@objc protocol InterestingNotchXPCHelperLunarListener {
...
@objc protocol InterestingNotchXPCHelperProtocol {
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     connectionToService = NSXPCConnection(serviceName: "com.nodescraper.interestingnotch.InterestingNotchXPCHelper")
     connectionToService.remoteObjectInterface = NSXPCInterface(with: (any InterestingNotchXPCHelperProtocol).self)
     connectionToService.resume()

 Once you have a connection to the service, you can use it like this:

     if let proxy = connectionToService.remoteObjectProxy as? InterestingNotchXPCHelperProtocol {
