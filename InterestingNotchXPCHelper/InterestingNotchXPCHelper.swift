//
//  InterestingNotchXPCHelper.swift
...
class InterestingNotchXPCHelper: NSObject, InterestingNotchXPCHelperProtocol {

    private weak var connection: NSXPCConnection?

    private let lunarStateQueue = DispatchQueue(label: "InterestingNotchXPCHelper.lunar.state")
    ...
    @objc func startLunarEventStream(with reply: @escaping (Bool) -> Void) {
        lunarStateQueue.async { [weak self] in
            ...
            } as? InterestingNotchXPCHelperLunarListener
