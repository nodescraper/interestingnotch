...
struct InterestingLargeButtons: View {
    var action: () -> Void
    var icon: Image
    var title: String
    var body: some View {
...
struct InterestingExtrasMenu : View {
    @ObservedObject var vm: InterestingViewModel
