...
class InterestingViewModel: NSObject, ObservableObject {
    @ObservedObject var coordinator = InterestingViewCoordinator.shared
    @ObservedObject var detector = FullscreenMediaDetector.shared

    let animationLibrary: InterestingAnimations = .init()
    ...
    func close() {
        ...
        if Defaults[.interestingShelf] && !ShelfStateViewModel.shared.isEmpty && Defaults[.openShelfByDefault] {
